...
if ($business_name === FALSE || $business_name === '') {
    $errorMessage['business_name'] = 'First Name must not be blank<br/>';
}
...
$businessId = $gateway->insertBusiness($businessId, $business_name, $business_address, $business_lat, $business_long, $business_type);
